...
float Solve3D::getScale(int level, int firstLevel, double scaleFactor)
{
    return (float)std::pow(scaleFactor, (double)(level - firstLevel));
}

void Solve3D::setPyramid(const Mat &img, const int levelsNum, const float scaleFactor,vector<Mat> &imagePyramid)
{
...
bool Solve3D::getCameraRT(const Mat &KMatrix,vector<Point3f> &P3D,vector<Point2f> &P2D,Mat &R,Mat &t,bool isTracked)
{
